...
<body style="background-image:url('../image/bg.gif');font-family:Old Standard TT, serif">
  ...
  <div class="topnav">
    ...
    <a style="font-family: Comic San; font-weight:bold; position:relative; right:10cm">PIXELS</a>
  </div>
      ...
      <form method="POST">
        <div class="flex-container">
          ...
          <a href="adminuserrecord.php">
            <button type="button" style="width:10%;border:1px solid black;background: #fefae0;font-size:16px;margin-right:20px"> Reset </a> </button>
        </div>
      </form>
